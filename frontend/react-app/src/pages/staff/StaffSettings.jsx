    ...
    <StaffLayout>
      <div className="max-w-2xl space-y-8">
        <div>
          ...
          <p className="text-sm text-on-surface-variant mt-1">Manage your preferences</p>
        </div>
            ...
            <div className="flex items-center gap-1 p-1 rounded-lg bg-surface-container-low border border-outline-variant/30">
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-bold transition-all ${
                  theme === "light" ? "bg-white shadow text-on-surface" : "text-on-surface-variant hover:text-on-surface"
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-bold transition-all ${
                  theme === "dark" ? "bg-slate-700 shadow text-white" : "text-on-surface-variant hover:text-on-surface"
                }`}
              >
          ...
          <div className="rounded-lg border border-outline-variant/30 bg-surface-container-low p-4">
            ...
            <div className="flex items-center gap-3">
              <div className="h-8 w-8 rounded-full bg-blue-100 flex items-center justify-center">
                <span className="material-symbols-outlined text-blue-700 text-[16px]">badge</span>
              </div>
              <div>
